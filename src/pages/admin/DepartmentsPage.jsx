...
export function DepartmentsPage() {
  ...
  const [hospitalName] = useState("Apollo Medical Center");
  ...
  const departments = [
    // Empty initially - will be populated from database
    // {
    //   id: 5,
  ...
  const handleEditDepartment = (id) => {
    // Navigate to edit department page or open modal
                    ...
                    {filteredDepartments.length === 0 ? (
                      ...
                      filteredDepartments.map((dept) => (
                        ...
                        >
                          ...
                          <td className="py-4 px-4">
                            <p className="text-gray-700">{dept.createdDate}</p>
                          </td>
                          <td className="py-4 px-4">
              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="deptName" className="text-sm font-semibold text-gray-700">
                      Department Name
                    </Label>
                    <Input
                      id="deptName"
                  ...
                  <div className="flex gap-3 pt-4">
                    <Button
                      type="submit"
                      className="bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white px-8 h-11 font-semibold shadow-md hover:shadow-lg transition-all"
                    >
                      Add Department
                    </Button>
                    <Button
